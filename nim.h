...
int Nimber(T_Case pion,int grille[VMAX][VMAX]);
...
void grille_nimber(int grille[VMAX][VMAX],int nlig,int ncol);
...
int Coup_Ordi_Gagnant(T_Case pion,T_Tab_Case tab_vois[],int nb_vois,int grille[VMAX][VMAX]);
...
int Coup_Ordi(int niveau,T_Case pion,T_Tab_Case tab_vois[],int nb_vois,int grille[VMAX][VMAX]);
#endif
